...
#  python WIMP_e.py  13.1 4 F test_e
# where 13.1 corresponds to the particle mass in MeV, 4 are the NDOF, and F corresponds to Fermi-Dirac Statistics.
# This will output the temperature evolution to Results/test_e.dat and Results/WIMPS/test_e_Neff.dat the Neff value
#####################################################################
import os
import sys
import numpy as np
